...
Requires LOS `clear` and `r ≤ max_range`. The round's impact scatters as an
...
Crest clearance (a ridge blocking the ballistic arc) reuses the LOS traversal
...
state validated against Lanchester.
