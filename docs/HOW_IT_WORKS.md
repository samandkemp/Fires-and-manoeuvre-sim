...
| [`docs/VALIDATION.md`](VALIDATION.md) | How do I know it is right? The V1–V70 gates |
...
The **V-gates** (V1-V70) are the project's backbone. Each one checks a model against a
