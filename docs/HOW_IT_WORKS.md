...
| [`docs/VALIDATION.md`](VALIDATION.md) | How do I know it is right? The V1–V68 gates |
...
The **V-gates** (V1-V68) are the project's backbone. Each one checks a model against a
