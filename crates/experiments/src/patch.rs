...
/// Split a comma-separated value list on commas that are **outside** brackets and quotes.
///
/// Shared by `sweep --values` and `factorial --factor`, so the two cannot disagree about
/// what a list of arms is.
///
