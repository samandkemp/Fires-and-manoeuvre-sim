...
| [docs/VALIDATION.md](docs/VALIDATION.md) | The V1–V66 gates, what each is checked *against*, and how to add one |
...
crates/validation/   the V1–V66 gates, checked through the public API only
...
and the kill chain. V1–V66 all hold.
