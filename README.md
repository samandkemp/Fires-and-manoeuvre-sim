...
| `crates/validation/` | The V1–V66 gates: every model checked against a closed form or a stated invariant |
...
invariant. The gates are numbered **V1–V66**, live in the `validation` crate, and each is
...
- **V60** — SEAD: a strike drone kills a command post, and the defence comes apart
