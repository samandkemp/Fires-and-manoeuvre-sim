...
- **The maths is the product.** Every model is formulated and validated against a known
  ...
  Correctness is testable; "realism" is not. There are 71 such gates.
...
| [docs/VALIDATION.md](docs/VALIDATION.md) | The V1–V71 gates, what each is checked *against*, and how to add one |
...
crates/validation/   the V1–V71 gates, checked through the public API only
...
and the kill chain. V1–V71 all hold.
